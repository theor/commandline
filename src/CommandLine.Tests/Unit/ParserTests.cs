...
namespace CommandLine.Tests.Unit
{
    ...
    {
        [Fact]
        public void Long_parameters_names_are_inferred()
        {
            // Fixture setup
            ...
            // Exercize system
            var result = sut.ParseArguments<FakeOptions>(new[]
                                                         {
                                                             "--stringvalue",
                                                             "strvalue",
                                                             "--intsequence",
        ...
        public void Same_value_in_two_parameters_are_parsed()
        {
            ...
            // Exercize system
            var result = sut.ParseArguments<FakeOptionsWithTwoIntegers>(new[]
                                                                        {
                                                                            "-a",
                                                                            "2",
                                                                            "-b",
